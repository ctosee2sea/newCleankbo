...
?>
		...
		<style>
			...
			#lecture {width:1050px;height:560px;}
			#lecture .player_wrap, #lecture .lec_summary {float:left;}
			#lecture .player_wrap {padding:60px 0px 0;width:547px;height:506px;background-color:#f3f3f3;}
			#lecture .lec_summary {padding:72px 0 0 43px; width: 40%;}
