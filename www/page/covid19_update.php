...
$i=0;
	while($row = sql_fetch_array($result)){
	 ...
	 $mail = ['ted@koreabaseball.or.kr', 'savio.moon@koreabaseball.or.kr','okjang@xanthus.co.kr'];
	 $hp = ['01031249078', '01046260622','01094739734','01035700662', '01091145528', '01073342283', '01031015526'];
	if($row['mb_2'] !=''){
   if($row['mb_2'] =="두산"){
    array_push($hp,'01028990170');
    array_push($mail, 'soweto@doosan.com');
    }
  else if($row['mb_2'] =="키움"){
	  array_push($hp,'01040270717');
	   array_push($mail, 'pch@heroesbaseball.co.kr');
    }  
	else if($row['mb_2'] =="SK"){
	  ...
	  array_push($hp,'01062792174');
	   array_push($mail, 'godong@sportslg.com');
    }	
    else if($row['mb_2'] =="NC"){
	  array_push($hp,'01085314070');
	   array_push($mail, '0206sea@ncdinos.com');
    }	
    else if($row['mb_2'] =="KT"){
	  array_push($hp,'01082796166');
	   array_push($mail, 'wj.han@kt.com');
    } else if($row['mb_2'] =="KIA"){
	  array_push($hp,'01097702065');
	   array_push($mail, 'woonbinee@kiatigers.co.kr');
    }	
    else if($row['mb_2'] =="삼성"){
	  array_push($hp,'01024273307');
	   array_push($mail, 'sejin79.lim@samsung.com');
    }    
    else if($row['mb_2'] =="한화"){
	  array_push($hp,'01096641010');
	   array_push($mail, 'namius@hanwha.com');
    }    
    else if($row['mb_2'] =="롯데"){
	  array_push($hp,'01036834793');
	   array_push($mail, 'jobong2000@lotte.net');
    } 
}
$row[hp]= str_replace(' ', '',$row[hp]);
...
$to = join('|',$mail);
$hp = join('|',$hp);
$subject = "[KBO] ".$mb2." ".$mb1." ".$mb_name."님이 ".$message."을 제출하셨습니다.";
$txt = "[KBO] ".$mb2." ".$mb1." ".$mb_name."님이 ".$message."을 제출하셨습니다.";
$headers = "From: noreply@cleankbo.com";
