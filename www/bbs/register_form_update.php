...
echo $_SESSION['ss_cert_dupinfo']."<br>";
if (!$_SESSION['ss_cert_dupinfo']) {
    // print_r($_SESSION);
    // exit();
}
...
if ($config['cf_cert_use'] && $cert_type && $md5_cert_no) {
    ...
    echo "hashkey:".$mb_name.$cert_type.$_SESSION['ss_cert_birth'].$md5_cert_no."<br>";
    $hash = md5($mb_name.$cert_type.$_SESSION['ss_cert_birth'].$md5_cert_no);
    echo "hash:".$hash."<br>";
    echo "hash:".$_SESSION['ss_cert_hash']."<br>";
    if ($_SESSION['ss_cert_hash'] == md5($cert_type.$_SESSION['ss_cert_birth'].$md5_cert_no)) {
        echo '해쉬 같음';
