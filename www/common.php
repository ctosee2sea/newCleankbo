...
$log = mysql_connect( "220.117.242.242", "kboclean", "kbokbo)^@(") or die("connect error.");
mysql_select_db("kboclean",$log);
mysql_query("set names utf8");

// $userAgent = $_SERVER["HTTP_USER_AGENT"]; 
// $ip = $_SERVER["REMOTE_ADDR"]; 
// mysql_query("INSERT into log (log,ip) values ('{$userAgent}','{$ip}')");
// 방문자수의 접속을 남김
