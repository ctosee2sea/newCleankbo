...
<div class="mbskin">
	...
	<table>
	<caption style="margin-top:29px;">선수정보 입력</caption>
	<tr>
		<td>
			<span class="frm_info">상태를 선택해주세요.</span>
			<a href="#프로선수" class="mb_1_btn<?php if ($member['mb_1']=='프로선수') echo ' on';?>">프로선수</a>
			<a href="#아마추어" class="mb_1_btn<?php if ($member['mb_1']=='아마추어') echo ' on';?>">아마추어</a>
			<a href="#일반" class="mb_1_btn<?php if ($member['mb_1']=='일반') echo ' on';?>">일반</a>
		</td>
	</tr>
	<tr>
		<td>
			<select name="mb_2" id="reg_mb_2">
				...
				<option value="넥센"<?php echo get_selected($member['mb_2'], '넥센'); ?>>넥센</option>
			...
			<span class="frm_info">일반 사용자는 소속구단을 선택하지 않아도 됩니다.</span>
		</td>
	</tr>
	</table>
	</div>
