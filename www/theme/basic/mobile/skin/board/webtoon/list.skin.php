            ...
            <ul class="gall_con">
                <li class="gall_href">
                    ...
                    <?php
                        ...
                        if($thumb['src']) {
                            $img_content = '<img src="'.$thumb['src'].'" alt="'.$thumb['alt'].'" class="img_fix">';
                        } else {
                            $img_content = '<img src="'.$board_skin_url.'/img/noimage.png" class=""img_fix">';
                        }
                ...
                <li class="gall_text_date"><?php echo str_replace('-', '.', $list[$i]['datetime']) ?></li>
            </ul>
        </li>
        <?php } ?>
