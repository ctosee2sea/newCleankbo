            ...
            <td class="td_subject">
                <a href="<?php echo $list[$i]['href'] ?>">
                    ...
                    if (isset($list[$i]['icon_secret'])) echo $list[$i]['icon_secret'];
										...
										$thumb = get_list_thumbnail($board['bo_table'], $list[$i]['wr_id'], $board['bo_mobile_gallery_width'], $board['bo_mobile_gallery_height'], false, true, 'top');
										if($thumb['src']) {
											$img_content = $thumb['src'];
										} else if($list[$i]['wr_1']){
											$img_content = $list[$i]['wr_1'];
										} else {
											$img_content = $board_skin_url.'/img/noimage.png';
										}
                    ?>
										</span>
										<img src="<?php echo $img_content; ?>" class="thumb">
