...
<div id="mid-area-1">
        ...
        <div class="bannerSet">
            ...
            <!-- 9월통신문 -->
            <div class="item"><a href="/bbs/board.php?bo_table=notice&wr_id=39"><img src="<?php echo G5_IMG_URL; ?>/banner/pc/notice_2009.jpg" id="july20"></a></div>
            <!-- 불법스포츠도박 -->
            ...
            <div class="item"><a href="<?php echo G5_URL; ?>/m/guidebook.php"><img src="<?php echo G5_IMG_URL ?>/banner/pc/guidebook_pc.jpg" class="img_fix"></a></div>
        </div>
    </div>
            <div id="mid-area-3">               
